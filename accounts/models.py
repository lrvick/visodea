...
class UserProfile(models.Model):
    ...
    performance = models.TextField(max_length=2000, blank=True)
    ...
    zip = models.DecimalField('ZIP', max_digits = 5, decimal_places=0, blank=True, null=True)
    ...
    def save(self):
        if not self.verification_key:
            ...
            self.verification_key = sha_constructor(''.join([random.choice(s) for i in range(len(s))])[:15]).hexdigest()
        super(UserProfile, self).save() #call the original save method
